      ...
      <div className="relative bg-[#111224] border border-[#6183FF]/20 rounded-3xl p-8 max-w-md w-full shadow-2xl overflow-hidden">
        ...
        {status === 'success' ? (
          <div className="text-center py-8">
            ...
            <h3 className="text-2xl font-bold text-white mb-3 tracking-tight">You're in! 🎉</h3>
            <p className="text-[#A0A4C8] text-lg leading-relaxed">
              Congratulations <span className="text-white font-medium">{email}</span>, you're on the list. We'll notify you as soon as early access opens.
            </p>
            <button 
              onClick={onClose}
